<div class="card" style="padding:0;background-image: url(<?php echo get_the_post_thumbnail_url(); ?>);background-position:center;background-size:cover;">
	<div class="p-3 py-4 d-flex justify-content-between flex-column" style="height:calc(100vh - 200px); background:linear-gradient(rgba(0,0,0,0.8),transparent, rgba(0,0,0,0.8)" title="<?php echo html_entity_decode(mb_strimwidth(get_the_excerpt(), 0, 150, ' ...'), ENT_QUOTES, 'UTF-8') ?>">
		...
		<div class=" d-flex justify-content-between flex-column">
			...
			?>
				<div class="d-flex h2 justify-content-center">
					<div>
						<span><?= $seoMeta['duration']; ?></span> <i class="fa fa-hand-o-right" aria-hidden="true"></i>
